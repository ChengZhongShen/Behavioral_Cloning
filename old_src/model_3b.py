...
# model_3-->mode.3b: add data_sample_rate choice, could let choice 1, 1/2, 1/3, 1/4, 1/5 sample rate, 
#                    since the neigbough image content is almost same. 2018/11/28
...
def load_log_file(path, sample_rate):
    '''
...
def load_images(lines, images, steerings, path, split, sub_read=False, sample_balance=False):
    '''
...
def load_sides_images(lines, images, steerings, path, split, offset, sub_read=False, sample_balance=False):
    '''
...
if __name__ == '__main__':
    ...
    train_model(data_path='../data/', data_split='/', data_sub_read=50, data_sample_balance=0.01, sides_image=True, sides_image_offset=0.22, data_augmentation=1, 
